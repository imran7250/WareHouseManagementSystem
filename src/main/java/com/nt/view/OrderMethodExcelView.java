...
public class OrderMethodExcelView extends AbstractXlsxView {
    ...
    protected void buildExcelDocument(
        ...
        header.createCell(1).setCellValue("ORDER MODE");
        header.createCell(2).setCellValue("ORDER CODE");
        header.createCell(3).setCellValue("ORDER TYPE");
        header.createCell(4).setCellValue("ORDER ACCEPT");
        ...
        for (OrderMethod om : list) {
            ...
            if (om.getOrderAcpt() != null) {
                row.createCell(4).setCellValue(String.join(", ", om.getOrderAcpt()));
            } else {
